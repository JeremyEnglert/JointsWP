...
function custom_post_accordion() { 
	...
	register_post_type( 'accordion', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			'name' => __( 'Accordion Post', 'jointswp' ), /* This is the Title of the Group */
			'singular_name' => __( 'Accordion Post', 'jointswp' ), /* This is the individual type */
			'all_items' => __( 'All Accordion Posts', 'jointswp' ), /* the all items menu item */
			'add_new' => __( 'Add New Accordion Post', 'jointswp' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Accodion Post', 'jointswp' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'jointswp' ), /* Edit Dialog */
			'edit_item' => __( 'Edit Accordion Post', 'jointswp' ), /* Edit Display Title */
			'new_item' => __( 'New Accordion Post', 'jointswp' ), /* New Display Title */
			'view_item' => __( 'View Accordion Posts', 'jointswp' ), /* View Display Title */
			'search_items' => __( 'Search Accordion Post', 'jointswp' ), /* Search Custom Type Title */ 
